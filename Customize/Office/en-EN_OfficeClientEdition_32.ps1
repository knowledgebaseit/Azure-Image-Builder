...
# Usage        : Office Install en-EN 32-bit
#*********************************************************************************
...
##########################################
#    en-EN_OfficeClientEdition_32.ps1    #
##########################################
...
write-host 'AIB Customization: Download XML file en-EN 32-bit'
$XML64URL = 'https://raw.githubusercontent.com/knowledgebaseit/AIB/main/Customize/Office/en-EN_OfficeClientEdition_32.xml'
$XML64DL = 'en-EN_OfficeClientEdition_32.xml'
$ProgressPreference = 'SilentlyContinue'
...
write-host "Starting Office en-EN 32-bit installation"
.\setup.exe /Configure c:\Temp\Office\en-EN_OfficeClientEdition_32.xml
.\After_Office_install.ps1
write-host "AIB Customization: Installation Office en-EN 64-bit Complete"