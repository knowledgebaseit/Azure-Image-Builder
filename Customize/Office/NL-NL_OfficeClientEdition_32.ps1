...
# Usage        : Office Install NL-NL 32-bit
#*********************************************************************************
...
##########################################
#    NL-NL_OfficeClientEdition_32.ps1    #
##########################################
...
$XML32URL = 'https://raw.githubusercontent.com/knowledgebaseit/AIB/main/Customize/Office/NL-NL_OfficeClientEdition_32.xml'
$XML32DL = 'NL-NL_OfficeClientEdition_32.xml'
$ProgressPreference = 'SilentlyContinue'
...
.\setup.exe /Configure c:\Temp\Office\NL-NL_OfficeClientEdition_32.xml
