...
# Usage        : Office Install ro-RO 32-bit
#*********************************************************************************
...
##########################################
#    ro-RO_OfficeClientEdition_32.ps1    #
##########################################
...
write-host 'AIB Customization: Download XML file ro-RO 32-bit'
$XML32URL = 'https://raw.githubusercontent.com/knowledgebaseit/AIB/main/Customize/Office/ro-RO_OfficeClientEdition_32.xml'
$XML32DL = 'ro-RO_OfficeClientEdition_32.xml'
$ProgressPreference = 'SilentlyContinue'
...
write-host "Starting Office ro-RO 32-bit installation"
.\setup.exe /Configure c:\Temp\Office\ro-RO_OfficeClientEdition_32.xml
.\After_Office_install.ps1
write-host "AIB Customization: Installation Office ro-RO 32-bit Complete"
