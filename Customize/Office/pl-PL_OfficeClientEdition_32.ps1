...
# Usage        : Office Install pl-PL 32-bit
#*********************************************************************************
...
##########################################
#    pl-PL_OfficeClientEdition_32.ps1    #
##########################################
...
write-host 'AIB Customization: Download XML file pl-PL 32-bit'
$XML64URL = 'https://raw.githubusercontent.com/knowledgebaseit/AIB/main/Customize/Office/pl-PL_OfficeClientEdition_32.xml'
$XML64DL = 'pl-PL_OfficeClientEdition_32.xml'
$ProgressPreference = 'SilentlyContinue'
...
write-host "Starting Office pl-PL 32-bit installation"
.\setup.exe /Configure c:\Temp\Office\pl-PL_OfficeClientEdition_32.xml
