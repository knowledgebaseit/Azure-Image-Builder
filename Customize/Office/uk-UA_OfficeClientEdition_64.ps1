...
# Usage        : Office Install uk-UA 64-bit
#*********************************************************************************
...
##########################################
#    uk-UA_OfficeClientEdition_64.ps1    #
##########################################
...
write-host 'AIB Customization: Download XML file uk-UA 64-bit'
$XML64URL = 'https://raw.githubusercontent.com/knowledgebaseit/AIB/main/Customize/Office/uk-UA_OfficeClientEdition_64.xml'
$XML64DL = 'uk-UA_OfficeClientEdition_64.xml'
$ProgressPreference = 'SilentlyContinue'
...
write-host "Starting Office uk-UA 64-bit installation"
.\setup.exe /Configure c:\Temp\Office\uk-UA_OfficeClientEdition_64.xml
.\After_Office_install.ps1
write-host "AIB Customization: Installation Office uk-UA 64-bit Complete"
